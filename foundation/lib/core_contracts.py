...
CORE_CONTRACTS: tuple[CoreContract, ...] = (
    ...
    CoreContract("dream_core", "idle consolidation and optimization", ("schedule", "consolidate", "archive", "metrics"), ("F:/AIOS_Clean/dream_core", "D:/LocalAi/AIOS_V1/dream_core"), ("foundation/lib/aios_dream.py", "foundation/lib/dream_core.py"), 15),
    CoreContract("data_core", "durable structured data stores", ("schema", "integrity", "provenance", "recovery"), ("F:/AIOS_Clean/data_core", "D:/LocalAi/AIOS_V1/data_core"), ("foundation/lib/data_core.py", "foundation/lib/aios_adapter_data.py"), 35),
    CoreContract("support_core", "shared health and model support", ("health", "cache", "diagnostics"), ("F:/AIOS_Clean/support_core", "D:/LocalAi/AIOS_V1/support_core"), ("foundation/lib/support_core.py", "foundation/lib/aios_adapter_support.py"), 30),
    CoreContract("utils_core", "validation, resilience, and bounded utility planning", ("validate", "retry", "freshness", "bounded_io"), ("F:/AIOS_Clean/utils_core", "D:/LocalAi/AIOS_V1/utils_core"), ("foundation/lib/utils_core.py", "foundation/lib/aios_adapter_utils.py"), 35),
    CoreContract("enterprise_core", "standards, compliance, and governed audit planning", ("standards", "compliance", "audit"), ("F:/AIOS_Clean/enterprise_core", "D:/LocalAi/AIOS_V1/enterprise_core"), ("foundation/lib/enterprise_core.py", "foundation/lib/cpu_enterprise_policy.py", "foundation/lib/aios_adapter_audit.py"), 70),
    CoreContract("rag_core", "provenance-preserving document retrieval", ("index", "retrieve", "source_hash", "abstain"), ("F:/AIOS_Clean/rag_core", "D:/LocalAi/AIOS_V1/rag_core"), ("foundation/lib/manual_oracle.py", "foundation/lib/aios_adapter_knowledge.py", "foundation/lib/rag_core.py"), 6),
    ...
    CoreContract("backup_core", "immutable backup, restore, and CPU intent planning", ("snapshot", "hash", "restore", "rollback"), ("F:/AIOS_Clean/backup_core", "D:/LocalAi/AIOS_V1/backup_core"), ("foundation/lib/cpu_backup_planner.py", "foundation/lib/backup_core.py", "foundation/lib/aios_adapter_backup.py"), 40),
    CoreContract("fractal_core", "recursive multi-scale reasoning", ("recursion", "bounded_depth", "cost", "policy", "allocation"), ("F:/AIOS_Clean/fractal_core", "D:/LocalAi/AIOS_V1/fractal_core"), ("foundation/lib/cpu_fractal_reasoner.py", "foundation/lib/fractal_core.py", "foundation/lib/aios_adapter_fractal.py", "foundation/lib/cpu_reasoning_pipeline.py"), 50),
    CoreContract("game_core", "simulation, personal analytics, and coaching", ("simulation", "determinism", "sandbox", "analytics", "coaching", "personal_only"), ("F:/AIOS_Clean/game_core", "D:/LocalAi/AIOS_V1/game_core"), ("foundation/lib/cpu_choice_simulator.py", "foundation/lib/game_core.py", "foundation/lib/aios_adapter_game.py", "foundation/lib/agentic_runtime.py"), 90),
    CoreContract("marketplace_core", "plugin discovery, metadata trust, and install policy", ("manifest", "trust", "install_gate", "catalog_search", "dependency_check"), ("F:/AIOS_Clean/marketplace_core", "D:/LocalAi/AIOS_V1/marketplace_core"), ("foundation/lib/marketplace_core.py", "foundation/lib/aios_adapter_marketplace.py"), 95, "optional", "Optional effect-closed capability; metadata may be reviewed, but installation, activation, publishing, and external network effects are outside CPU authority."),
    CoreContract("music_core", "music selection, preference planning, and output gate", ("routing", "sandbox", "output_gate", "selection", "preference_plan"), ("F:/AIOS_Clean/music_core", "D:/LocalAi/AIOS_V1/music_core"), ("foundation/lib/music_core.py", "foundation/lib/aios_adapter_music.py"), 95, "optional", "Optional effect-closed peripheral; playback, preference writes, library scans, and random selection are not authoritative cognition."),
    CoreContract("privacy_core", "privacy controls, retention, transparency, and consent", ("redaction", "consent", "audit", "retention", "transparency", "reversible_disable"), ("F:/AIOS_Clean/privacy_core", "D:/LocalAi/AIOS_V1/privacy_core"), ("foundation/lib/cpu_privacy_policy.py", "foundation/lib/privacy_core.py", "foundation/lib/aios_adapter_privacy.py"), 45),
    ...
    CoreContract("main_core", "kernel routing", ("boot", "queue", "health", "shutdown"), ("F:/AIOS_Clean/main_core", "D:/LocalAi/AIOS_V1/main_core"), ("foundation/aios_main.py", "foundation/auto_main.py", "foundation/lib/main_core.py"), 12),
    CoreContract("infra_core", "deployment, CI, monitoring, and rollback planning", ("health", "lkg", "rollback", "ci", "deployment_gate"), ("F:/AIOS_Clean/infra_core", "D:/LocalAi/AIOS_V1/infra_core"), ("foundation/lib/infra_core.py", "foundation/lib/aios_adapter_infra.py", "foundation/lib/cpu_infra_ops_judge.py", "foundation/lib/foundation_health.py"), 55),
...
def contract_report() -> dict[str, Any]:
    ...
    for contract in CORE_CONTRACTS:
        ...
        if contract.disposition != "authoritative_cpu":
            state = contract.disposition
        else:
