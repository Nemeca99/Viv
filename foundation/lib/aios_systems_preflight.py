...
_ROADMAP_BY_CORE: dict[str, dict[str, Any]] = {
    ...
    "sandbox_core": {
        ...
        "viv_build_status": "PARTIAL",
        "foundation_layer": "security_envelope",
        "triangulation_disposition": "Contained execution under Law 7 sandbox; no bypass of Security IN/OUT",
    },
    "carma_core": {
        "cold_start_phase": 2,
    ...
    "perception_core": {
        ...
        "viv_build_status": "NONE",
        "foundation_layer": "perception",
        "triangulation_disposition": "Multi-sense skeleton; hearing NONE; vision/text via existing adapters",
    },
    "audit_core": {
        "cold_start_phase": 6,
    ...
    "ethics_core": {
        "cold_start_phase": 7,
        "viv_build_status_row": "§14 Symbiotic Ethics / Adaptive Behavior",
        "viv_build_status": "NONE",
        "foundation_layer": "dream_ethics",
        "triangulation_disposition": "Skeleton slot only; no adaptive loop / no soft-0.99",
    },
    "infra_core": {
        "cold_start_phase": 8,
    ...
    "federation_core": {
        ...
        "viv_build_status": "NONE",
        "foundation_layer": "hardware_distributed",
        "triangulation_disposition": "Plan-only HOLD on node_federation*; no endpoint activation",
    },
    "federation": {
        "cold_start_phase": 8,
        "viv_build_status_row": "§17 Hardware Agnosticism",
        "viv_build_status": "NONE",
        "foundation_layer": "hardware_distributed",
        "triangulation_disposition": "Alias of federation_core; orchestrator gap id",
    },
    "fractal_core": {
        "cold_start_phase": 8,
        "viv_build_status_row": "§5 Software Architecture",
