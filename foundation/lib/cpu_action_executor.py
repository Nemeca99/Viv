...
def execute_contract(contract: Mapping[str, Any], state: Mapping[str, Any]) -> dict[str, Any]:
    ...
    if action == "idle" and not contract.get("side_effects_allowed") and not effects:
        ...
        allowed = {"cpu_core_probe", "cpu_core_survey", "cpu_reasoning_probe", "cpu_choice_simulation", "cpu_choice_live_probe", "cpu_cleanup_plan", "cpu_rid_shadow_probe", "cpu_sandbox_probe"}
