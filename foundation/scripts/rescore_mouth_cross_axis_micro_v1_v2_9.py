#!/usr/bin/env python3
"""Read-only rescore of the cross-axis 96-case report under evaluator v2.9."""
...
def main() -> int:
    ...
    output = {
        "schema_version": "mouth_cross_axis_micro_full96_rescore_v2_9",
    ...
    target = ROOT / "FULL_96_RESCORE_V2_9.json"
    if target.exists():
