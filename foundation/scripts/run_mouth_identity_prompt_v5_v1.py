#!/usr/bin/env python3
"""Governed identity refinement using the v5 CPU-authored prompt contract."""
...
ROOT = FOUNDATION / (
    ...
    "campaigns/mouth_identity_prompt_v5_v1"
)
TRAIN = FOUNDATION / (
    "artifacts/auto/openaster_training_tree/stage1_mouth_generation_canary_v4/"
    "campaigns/mouth_identity_complete_v2/train_96.jsonl"
)
PARENT = FOUNDATION / "models/Training/runs/mouth_cross_axis_micro_v1/adapter_step_8"
ID = "mouth_identity_prompt_v5_v1"
...
base.ANCHOR_STRENGTH = 1000.0
base.PROMPT = (
    "You are Viv's GPU mouth inside AIOS. CPU reasoning and the supplied "
    "identity contract are authoritative. Speak naturally from verified "
    "context. Do not claim human identity or independent tool agency."
)
