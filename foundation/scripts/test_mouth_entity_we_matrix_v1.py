#!/usr/bin/env python3
"""Verify project-we, human-we, and ambiguous-we matrix behavior."""
...
ROOT = FOUNDATION / "artifacts/auto/openaster_training_tree/stage1_mouth_generation_canary_v4/campaigns/mouth_entity_we_matrix_v1"
...
def main() -> int:
    ...
    print({"ok": True, "rows": len(rows), "status_counts": dict(counts), "entity_we_boundary": True, "hold_only": True})
    return 0
