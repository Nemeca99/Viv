#!/usr/bin/env python3
"""Verify the current expanded semantic bundle audit after entity-we changes."""
...
REPORT = FOUNDATION / "artifacts/auto/openaster_training_tree/stage1_mouth_generation_canary_v4/campaigns/mouth_semantic_refinement_v22_42/SEMANTIC_BUNDLE_AUDIT_V15.json"
