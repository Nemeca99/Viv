#!/usr/bin/env python3
"""CPU-only adjudication of the cross-axis micro full-96 HOLDs."""
from __future__ import annotations
import json,sys
from datetime import datetime,timezone
from pathlib import Path
FOUNDATION=Path(__file__).resolve().parents[1]; ROOT=FOUNDATION/"artifacts/auto/openaster_training_tree/stage1_mouth_generation_canary_v4/campaigns/mouth_cross_axis_micro_v1"; CACHE=ROOT/"cpu_sensor_cache"; sys.path.insert(0,str(FOUNDATION)); from lib.evaluator_v2_3_hybrid_v1_2_5 import judge  # noqa: E402
def main():
