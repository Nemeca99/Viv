#!/usr/bin/env python3
"""Governed two-row, two-step identity-gap repair; promotion remains impossible."""
...
base.ROOT = ROOT
base.TRAIN = ROOT / "train_2.jsonl"
base.PARENT = FOUNDATION / "models/Training/runs/mouth_cross_axis_micro_v1/adapter_step_8"
base.ID = "mouth_identity_gap_micro_v1"
base.OPTIMIZER_ROWS = 2
base.OPTIMIZER_STEPS = 2
base.LEARNING_RATE = 1e-6
base.CHECKPOINT_STEPS = (1, 2)
