"""Build v11 with globally distinct contract-equivalent replacements."""
...
OUT_ROOT = ROOT / "campaigns/mouth_combined_candidate_v11"
...
def main() -> int:
    if OUT_ROOT.exists():
        raise FileExistsError("refuse_overwrite:mouth_combined_candidate_v11")
    ...
    for row in rows:
        ...
        row["dedup_repair"] = "v11_distinct_contract_equivalent_target"
        replacements += 1
    ...
    manifest = {
        "schema_version": "mouth_combined_candidate_corpus_v11",
