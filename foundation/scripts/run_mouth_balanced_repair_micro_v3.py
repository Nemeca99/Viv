#!/usr/bin/env python3
"""Third governed balanced repair micro with explicit CPU axis contracts."""
...
ROOT = FOUNDATION / (
    ...
    "campaigns/mouth_balanced_repair_micro_v3"
)
TRAIN = FOUNDATION / (
    "artifacts/auto/openaster_training_tree/stage1_mouth_generation_canary_v4/"
...
ID = "mouth_balanced_repair_micro_v3"
...
base.PROMPT = (
    ...
    "are authoritative. Use the CPU contract for the requested axis. Do not "
