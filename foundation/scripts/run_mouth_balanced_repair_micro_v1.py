#!/usr/bin/env python3
"""Governed balanced repair micro-run using the shared v5 prompt renderer."""
...
ID = "mouth_balanced_repair_micro_v1"
...
base.PROMPT = (
    ...
    "are authoritative. Speak naturally, state the Viv/AIOS identity when "
    "asked, and do not claim human identity or independent tool agency."
)
