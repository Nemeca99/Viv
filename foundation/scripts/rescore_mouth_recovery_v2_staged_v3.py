#!/usr/bin/env python3
"""Rescore existing staged outputs with the calibrated human-comparison judge."""
...
def main() -> int:
    ...
    result = {
        "schema_version": "mouth_recovery_v2_staged_rescore_v3",
    ...
    target = ROOT / "STAGED_GENERATION_REScore_V3.json"
    if target.exists():
