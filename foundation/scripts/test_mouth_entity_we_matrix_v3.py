#!/usr/bin/env python3
"""Verify the deduplicated v3 entity-we boundary matrix."""
...
ROOT = FOUNDATION / "artifacts/auto/openaster_training_tree/stage1_mouth_generation_canary_v4/campaigns/mouth_entity_we_matrix_v3"
...
def main() -> int:
    ...
    assert len(rows) == 24 and len(set(targets)) == 24
    counts = Counter()
    for row in rows:
