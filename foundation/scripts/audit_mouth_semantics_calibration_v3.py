"""Audit v3 calibration labels against the deterministic evaluator."""
...
ROOT = FOUNDATION / "artifacts/auto/openaster_training_tree/stage1_mouth_generation_canary_v4/campaigns/mouth_semantics_calibration_v3"
SOURCE = ROOT / "calibration_64.jsonl"
# Never overwrite the first audit; each re-audit is a new immutable receipt.
OUT = ROOT / "CALIBRATION_EVALUATION_REAUDIT.json"
AXIS = {
...
def main() -> int:
    ...
    report = {
        "schema_version": "mouth_semantics_calibration_evaluation_v3",
