#!/usr/bin/env python3
"""Evaluate a Part 5 self-attention checkpoint over validation windows."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not isinstance(config, dict):
        raise ValueError("checkpoint_config_missing")
    ...
    result = {
        "schema_version": "uml_part5_self_attention_validation_v1",
