...
from paths import FOUNDATION, MODEL_ROOT, RUN_ROOT, TRAINING_ROOT, VIV_ROOT  # noqa: E402

INPUT_ROOT = VIV_ROOT / "models" / "viv_slm_identity_personality_v1" / "inputs"
DEFAULT_OUTPUT = RUN_ROOT / "identity_personality_steps_1000"
MODEL_EXPERIMENT_ROOT = MODEL_ROOT
