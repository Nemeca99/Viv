#!/usr/bin/env python3
"""Verify v2 model inputs preserve the clean identity corpus contract."""
...
INPUTS = FOUNDATION.parent / "models" / "viv_slm_identity_personality_v2" / "inputs"
...
def main() -> int:
    ...
    print(
        "VIV_SLM_TRAINING_INPUTS_V2_PASS "
        ...
        "context=128 stride=1 termination=<END> "
