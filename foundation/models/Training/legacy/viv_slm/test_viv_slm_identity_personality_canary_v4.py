#!/usr/bin/env python3
"""Load the selected v4 checkpoint as a read-only CPU canary."""
...
CHECKPOINT = VIV_ROOT / "models" / "viv_slm_identity_personality_v4" / "runs" / "identity_personality_steps_1250" / "checkpoint.pt"
VOCAB = VIV_ROOT / "models" / "viv_slm_identity_personality_v4" / "inputs" / "VOCAB.json"
...
def main() -> int:
    ...
    assert status["training_steps"] == 1250
    ...
    print(
        "VIV_SLM_IDENTITY_PERSONALITY_CANARY_V4_PASS "
